...
<head>
    ...
    <style>
        ...
        .th-navbar-item-dd
        .th-navbar-item:hover a {
            color: #039BE5;
        }

        .menu-minimized .col-sidenav {
...
<body>
    ...
    <div id="offcanvas-nav" uk-offcanvas="mode: slide; overlay: true; flip: true">
        <div class="uk-offcanvas-bar">
            ...
            <ul class="uk-nav uk-nav-default">
                <li  class="{{ Request::routeIs('budget') ? 'uk-active' : '' }}"><a href="{{ route('budget') }}">Budget</a></li>
                <li  class="{{ Request::routeIs('eventor') ? 'uk-active' : '' }}"><a href="{{ route('eventor') }}">Eventor</a></li>
    ...
    <div class="uk-width-1-1 "><a href="http://new.teftele.com/logout?token=qgH8Z217juVMgHxL5uo84paIhBOBtHSzIayDwmYy" class="app-item login-btn">
  
  </a><nav id="sidebarMenu" class="col-sidenav uk-background-muted"><a href="http://new.teftele.com/logout?token=qgH8Z217juVMgHxL5uo84paIhBOBtHSzIayDwmYy" class="app-item login-btn">
      </a><div class="position-sticky pt-3"><a href="http://new.teftele.com/logout?token=qgH8Z217juVMgHxL5uo84paIhBOBtHSzIayDwmYy" class="app-item login-btn">
      </a><a class="uk-navbar-toggle " id="leftSidenavToggler2" style="justify-items: none;">
      <div class="uk-width-1-1 " style="padding: 3px;">
            <span uk-navbar-toggle-icon="" class="uk-icon uk-navbar-toggle-icon"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><style>.uk-navbar-toggle-animate svg &gt; [class*='line-'] {
        ...
        .uk-navbar-toggle-animate[aria-expanded="true"] svg &gt; .line-4 { transform: translateY(-6px) scaleX(0); }</style><rect class="line-1" y="3" width="20" height="2"></rect><rect class="line-2" y="9" width="20" height="2"></rect><rect class="line-3" y="9" width="20" height="2"></rect><rect class="line-4" y="15" width="20" height="2"></rect></svg></span>
</div>
        </a>
                  <br>
        <ul class="nav flex-column">
            ...
            <a class="nav-link active" aria-current="page" href="http://new.teftele.com/budger/catmanager">
              ...
              <div class="sidebar-heading uk-padding-x-small uk-text-uppercase uk-text-medium">
                ...
                <span class="nav-divider-icon"><i class="bi-dot uk-icon" uk-icon="icon: flickr" title="ST"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle cx="5.5" cy="9.5" r="3.5"></circle><circle cx="14.5" cy="9.5" r="3.5"></circle></svg></i></span>
            </div>
              <ul class="nav flex-column">
                          <li class="nav-item">
        ...
        <div class="uk-modal-dialog uk-modal-body">
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline uk-width-1-1">
                    <input class="uk-input" type="password" id="reg_password" placeholder="Enter your password" required>
                    <button class="uk-form-icon uk-form-icon-flip" onclick="togglePasswordVisibility()" type="button" uk-icon="icon: unlock"></button>
                </div>
            </div>
            <div class="uk-margin">
                <label class="uk-form-label" for="reg_confirm-password">Confirm Password:</label>
                <input class="uk-input" type="password" id="reg_confirm-password" placeholder="Confirm your password" required>
            </div>
